...
import org.ifaco.migratio.Fun.Companion.td1Dur
import org.ifaco.migratio.Fun.Companion.textFont
import org.ifaco.migratio.R
import org.ifaco.migratio.Select
import org.ifaco.migratio.Select.Companion.conCheck
import org.ifaco.migratio.data.Continents
import org.ifaco.migratio.data.Country
import org.ifaco.migratio.data.Works
...
class ConAdap(val c: Context, val list: List<Country>) :
    ...
    override fun onBindViewHolder(h: MyViewHolder, i: Int) {
        ...
        tvCont.text = c.resources.getString(Continents.values()[list[i].continent].label)
