...
public class DirectoryChooserFragmentTest {
    ...
    public static void startFragment(@NonNull final Fragment fragment, @Nullable Class activityClass) {
        final AppCompatActivity activity = (AppCompatActivity) Robolectric
                .buildActivity(activityClass == null ? AppCompatActivity.class : activityClass)
                .create()
                .start()
                .resume()
                .get();
    ...
    private static class DirectoryChooserActivityMock extends AppCompatActivity implements
    ...
    private static class CustomDirectoryChooserActivity extends AppCompatActivity {
        @Override
